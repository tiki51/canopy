defmodule Canopy.Runtime.Commands do
  ...
  @commands %{"handoff" => :handoff, "delegate" => :delegate}

  @type parsed ::
          :text | {:command, :handoff | :delegate, String.t(), String.t()} | {:error, String.t()}
